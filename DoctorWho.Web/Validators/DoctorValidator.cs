...
namespace DoctorWho.Web.Validators
{
    public class DoctorValidator : AbstractValidator<Models.DoctorForCreationDto>
    {
        ...
        {
            RuleFor(doctor => doctor.LastEpisodeDate).Null().When(doctor => doctor.FirstEpisodeDate == null).WithMessage("If First Episode Date is null, Last Episode Date must be null");
